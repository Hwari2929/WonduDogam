...
# 창 밖으로 이만큼 더 그립니다 (0..100 좌표).
#
# 가장자리에서 액자처럼 잘리지 않게 하는 것이 첫째지만, 100%에서도 지도를 조금
# 밀 수 있게 하려면 밀어낸 만큼 뒤에 그림이 있어야 합니다. 검색 종이와 도크가
# 지도 위에 늘 떠 있어서, 그 밑에 깔린 강화도나 경기 동부를 꺼내 보려면 밀 수
# 있어야 합니다. 22 는 화면 폭의 22% 만큼 밀 수 있다는 뜻입니다.
PAD = 22.0
